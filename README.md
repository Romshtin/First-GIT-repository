...
***
## Homework_2: Извлечение и установка переменной в окружение из одного запроса и передача её в другой (JSON Extractor, BeanShell Assetion, BeanShell PreProcessor).
